...
**Abertas: E1.8, E2.4, E1.7a e E1.7c.** As quatro têm arquivos disjuntos
(`07-*`, `wafc/`, `06a-*`, `06-*`), então podem correr juntas; as três de
`derivations/` não se tocam porque cada uma escreve o seu número.
