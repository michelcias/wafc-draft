...
| E1.1 notação | esboço; congela no chat principal | `notacao.md` |
| E1.2 a E1.7, E2, E3, E4, E5, E6, E7 | não abertas | |
...
| E0.3 (autor) | `docs/ss-instrucoes-autores.md` com a transcrição das instruções da *Statistica Sinica*; `manuscript/ss-template/` com o template compilando; quartil 2024 da SS conferido no SCImago e anotado em `alvo-revista.md` §1 | nada | `docs/ss-instrucoes-autores.md`, `manuscript/ss-template/*`, `docs/alvo-revista.md` (§1 e §3), `docs/handoff-E0.3.md` |
