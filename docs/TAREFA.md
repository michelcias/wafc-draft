...
**Em curso: E2.4 e E6.1a.** Elas só se cruzam em `wafc/`, e cada uma escreve
os seus arquivos (`04-pilot.R` e `05-sondagem-aplicacao.R`). **O catálogo não
tem tarefa aberta**; a próxima é E2.5 (go/no-go), que precisa dos números de
E2.4, e a lista do que E2.4 herda fora do catálogo dela está na §5 do
`ESTADO.md`.
