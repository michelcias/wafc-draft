...
| E6.1a sondagem de bases | **em curso** (aberta em 2026-09-20) | catálogo da §3 |
...
**Em curso: E6.1a. Aberta no catálogo: E2.4b**, que recolhe as emendas que
E2.4 não podia fazer. **E2.5 (go/no-go) só deve abrir depois de E2.4b**, por
duas razões medidas: o veredito contra os concorrentes muda com a grade de
`J` (P1), e o cenário suave que D30 quer medir depende da componente nova em
`dgp.R`.
