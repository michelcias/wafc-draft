...
\label{rem:cone}
A parte (iv) transfere o autovalor mínimo cheio, que é o que o regime de
resolução $2^{J_n} \asymp n^{1/(2\seff+1)}$ de E1.6 disponibiliza sem custo: ali $p q 2^{J}\log(pq2^{J})/n \to 0$
