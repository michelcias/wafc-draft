...
% Molde: Bühlmann & van de Geer (2011), Seção 6.2 (Teoremas 6.1 e 6.2), com
...
2011, Seção~6.2.3) as coloca dentro do suporte $S$ e exige a compatibilidade
...
\begin{itemize}[nosep, leftmargin=*]
  \item Bühlmann, P.\ e van de Geer, S. (2011). \emph{Statistics for
    ...
    verificada em L1.) Seção~6.2: Teorema~6.1 (taxa lenta), Teorema~6.2 (taxa
    rápida sob compatibilidade), Seção~6.2.3 (coordenadas não penalizadas).
    \textsc{[verificar numeração]}
  ...
  \item Tropp, J.~A. (2012). User-friendly tail bounds for sums of random
    ...
    (\texttt{tropp2012user} na bibliografia do WALL; ainda não está no
    \texttt{.bib} verificado.) Usada por E1.4, citada aqui só pela
